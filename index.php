...
<head>
    ...
    <meta name="keywords" content="UGC API score, PBAS calculation, CAS promotion points, Assistant Professor API, UGC API, UGC API calculator, ugc api score, ugc api score calculator, ugc pbas calculator, ugc cas api calculator, academic performance indicator calculator, ugc api score online">
    ...
    <title>HOME - UGC API Calculator</title>
    <link rel="icon" type="image/gif" href="calculatorlogo.jpeg" height="200px" width="200px"/>
...
.navbar_list a:hover {
    color: #7b5fc2;
        ...
        .success {
            margin-top: 15px;
            color: #d4edda;
            background: rgba(212, 222, 237, 0.2);
            padding: 10px;
            border-radius: 5px;
            display: none;
        }
...
.button-group {
  display: flex;
  flex-wrap: wrap;      /* Allows buttons to wrap if the screen gets too narrow */
  gap: 15px;            /* Space between buttons */
  justify-content: center; /* Centers buttons horizontally on desktop */
  align-items: center;
  padding: 20px;
  width: 100%;
  box-sizing: border-box;
...
<section>
    <div class="container">
        <div class="left">
            <img src="animation.gif" alt="UGCAPICalculator"> 
            <div class="google-review-wrap">
                <a href="https://www.google.com/search?sca_esv=ebc5d8cf5f3ae0dd&sxsrf=ANbL-n7h-7yKAc6yV0CoJyv-4BFktKPA7g:1770608061293&si=AL3DRZEsmMGCryMMFSHJ3StBhOdZ2-6yYkXd_doETEE1OR-qOWkZlKcAXlRIRmfYPUlYqDw2d772au7M4ANVOVkg7K4DCP8cxhn6PLCMGKL892L9-ei1pCa1hLjUkIHxSIdSHyKGv7oOW3BjGvCQPiM-p7eRwTzZ24cxLt4_74vi5dYhD7Ftexg%3D&q=Genome+Biotech+Publication+Services+Reviews&sa=X&ved=2ahUKEwjIoZ6EvcuSAxWkRWwGHY0xGm0Q0bkNegQIIBAF&biw=1280&bih=559&dpr=1.5#lrd=0x3973716a8f335ddf:0xe21b9d0d7c38c65b,3,,,," target="_blank">
                    <img src="images.png" alt="Rate us on Google" class="review-img-small">
                </a>  
            </div>
        </div>
        
        <div class="right">
            <h1>Master Your API Score with Ease</h1>
            <p>Navigate your score under UGC Regulation effortlessly</p>
            <h3>The Academic's #1 API & CAS Tracking Software</h3>

            <ul class="list">
                <li>Calculate API scores for all UGC categories automatically</li>
                <li>Verify eligibility for Career Advancement Scheme (CAS) promotions</li>
                <li>Simulate scenarios to identify gaps and improve your score</li>
                <li>Generate ready-to-submit reports in official UGC formats</li>
                <li>Stay updated with the latest Gazette notifications and amendments</li>
            </ul>
            
            <div class="button-row">
                <a href="index1.php" class="dbtn1">UGC API 2018</a>
                <a href="index3.php" class="dbtn2">UGC API 2025</a>
                <a href="BSUSC2026.HTML" class="dbtn3">BSUSC 2026</a>
                <a href="JPSC calculate API form.php" class="dbtn4">JPSC 2026</a>
...
<div class="mycontainer">
    <div>
        <h2>✔️ Smart Academic Performance Tracking</h2>
        <ul>
            <li>Instantly calculate your API score as per UGC norms.</li>
            <li>Avoid manual mistakes in score calculation.</li>
            <li>Get accurate results within seconds.</li>
            <li>Track your yearly academic performance easily.</li>
            <li>Stay updated with UGC scoring structure.</li>
            <li>Save time compared to spreadsheet calculations.</li>
        </ul>
    </div>

    <div>
        <h2>✔️ Easy Documentation & Career Planning</h2>
        <ul>
            <li>Helps in promotion and CAS applications.</li>
            <li>Organizes your academic activities systematically.</li>
            <li>Supports self-assessment for faculty members.</li>
            <li>Makes performance review simple and transparent.</li>
            <li>Useful for preparing institutional reports.</li>
            <li>Keeps your academic records ready anytime.</li>
        </ul>
    </div>
    
    <div>
        <h2>✔️ Faster Decisions with User-Friendly Tools</h2>
        <ul>
            <li>Simple interface for quick data entry.</li>
            <li>No technical skills required to use.</li>
            <li>Portable - access it anytime, anywhere.</li>
            <li>Reduces paperwork and confusion.</li>
            <li>Improves planning for future academic goals.</li>
            <li>Increases confidence before official submission.</li>
        </ul>
    </div>
</div>
<style>
   ...
   .testimonial-section {
        ...
        display: block;         /* NEW: Force flex */
        flex-direction: column;/* Stack header above slider */
    ...
    .slider-wrapper {
        ...
        width: 100%;           /* Take full width to allow centering inside */
        max-width: 900px;      /* But don't get too big */
        margin: 0 auto;
    }
    ...
    .testimonial-item {
        ...
        width: 100%;
        flex-direction: column;
        align-items: center;    /* Center the image/stars/name */
        text-align: center;
    }
...
.image-container img {
    ...
    .arrow-btn:hover { background: #6a5acd; color: #fff; }
    .prev { left: -80px; }
    .next { right: -80px; }
    ...
    @media (max-width: 900px) {
        .slider-wrapper { max-width: 90%; }
        .prev { left: -20px; }
        .next { right: -20px; }
        .arrow-btn { background: rgba(255,255,255,0.8); box-shadow: 0 2px 5px rgba(0,0,0,0.1); }
    }
...
<section class="testimonial-section">
    <div class="testimonial-header">
        <h2>Testimonials</h2>
        <p>Read genuine feedback from our community.</p>
    </div>

    <div class="slider-wrapper">
        <button class="arrow-btn prev" onclick="moveSlide(-1)">&#10094;</button>
        <button class="arrow-btn next" onclick="moveSlide(1)">&#10095;</button>

        <div class="testimonial-container">
            <div class="testimonial-item active">
                <div class="image-container">
                    <img src="ankit sir.jpeg" alt="Amy">
                    <div class="quote-badge">“</div>
                </div>
                <p class="testimonial-content">This content is now forced to the center using flex-alignment.</p>
                <div class="star-rating" style="color:#ffcc00">★★★★★</div>
                    <h4 class="user-name">Ankit Bhardwaj</h4>
                <span class="user-role">Visualizer of Interiors</span>
            </div>
            ...
            <div class="testimonial-item">
                ...
                <p class="testimonial-content">This content is now forced to the center using flex-alignment.</p>
                <div class="star-rating" style="color:#ffcc00">★★★★☆</div>
                    <h4 class="user-name">abc</h4>
                <span class="user-role">Visualizer of Interiors</span>
            </div>
            
            <div class="testimonial-item">
                <div class="image-container">
                    <img src="Nitin sir.jpeg" alt="Nitin">
                    <div class="quote-badge">“</div>
                </div>
                <p class="testimonial-content">Second slide content centered.</p>
                <div class="star-rating" style="color:#ffcc00">★★★★<img src= "star.png" height=14px width=14px> </div>
                <h4 class="user-name">NITIN WAHI</h4>
                <span class="user-role">Senior Designer</span>
            </div>
        </div>
    </div>
...
<style>
    ...
    padding: 60px 20px;
    text-align: center;
    background: #ffffff; /* Contrast against the dark calculator */
...
<section class="research-section">
    <div class="research-content">
        <h2>Add your Own Research Papers</h2>
        <p>With our Latest Publication.</p>
        <a href="journal-enhanced (1).html" class="research-btn" target="_blank">
            <span>📄</span> Our Research Journal
...
<section class="research-section">
    <div class="research-content">
        <h2>Add your Own Student Projet</h2>
        <p>With our Latest Publication.</p>
        <a href="studentproindex.php" class="research-btn" target="_blank">
            <span>📄</span> Student Project
...
<script>
    ...
    stars.forEach((star, index) => {
        star.addEventListener('click', () => {
            ...
            message.innerHTML = `<strong>Thank you for the ${rating} star rating!</strong>`;
            message.style.color = "#6f42c1";

            setTimeout(() => {
                const feedbackTarget = document.getElementById('feedback-section');
                if (feedbackTarget) {
...
<footer class="site-footer">
    <div class="footer-container">
        ...
        <div class="footer-column">
            ...
            <nav class="social-links">
                <a href="https://wa.me/918923944414">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi-bi-whatsapp" viewBox="0 0 16 16">
                        <path d="M13.601 2.326A7.85 7.85 0 0 0 7.994 0C3.627 0 .068 3.558.064 7.926c0 1.399.366 2.76 1.057 3.965L0 16l4.204-1.102a7.9 7.9 0 0 0 3.79.965h.004c4.368 0 7.926-3.558 7.93-7.93A7.9 7.9 0 0 0 13.6 2.326zM7.994 14.521a6.6 6.6 0 0 1-3.356-.92l-.24-.144-2.494.654.666-2.433-.156-.251a6.56 6.56 0 0 1-1.007-3.505c0-3.626 2.957-6.584 6.591-6.584a6.56 6.56 0 0 1 4.66 1.931 6.56 6.56 0 0 1 1.928 4.66c-.004 3.639-2.961 6.592-6.592 6.592m3.615-4.934c-.197-.099-1.17-.578-1.353-.646-.182-.065-.315-.099-.445.099-.133.197-.513.646-.627.775-.114.133-.232.148-.43.05-.197-.1-.836-.308-1.592-.985-.59-.525-.985-1.175-1.103-1.372-.114-.198-.011-.304.088-.403.087-.088.197-.232.296-.346.1-.114.133-.198.198-.33.065-.134.034-.248-.015-.347-.05-.099-.445-1.076-.612-1.47-.16-.389-.323-.335-.445-.34-.114-.007-.247-.007-.38-.007a.73.73 0 0 0-.529.247c-.182.198-.691.677-.691 1.654s.71 1.916.81 2.049c.098.133 1.394 2.132 3.383 2.992.47.205.84.326 1.129.418.475.152.904.129 1.246.08.38-.058 1.171-.48 1.338-.943.164-.464.164-.86.114-.943-.049-.084-.182-.133-.38-.232"/>
                    </svg>
                </a>
                <a href="https://www.instagram.com/genome.biotech/?hl=en">
                ...
                <a href="https://www.linkedin.com/in/dr-nitin-wahi-6095431a/">
    ...
    <div class="footer-bottom">
        <p>Â© <span id="year">2026</span> UGC API Calculator. All rights reserved.</p>
    </div>
</footer>
