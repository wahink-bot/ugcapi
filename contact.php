...
<head>
    ...
    <title>CONTACT US - UGC API Calculator</title>
      <link rel="icon" type="image/png" href="calculatorlogo.jpeg">
...
.error-text {
    ...
    font-size: 0.85rem;
    margin-top: 5px;
    display: none; /* Hidden until validation fails */
}
...
<section class="hero">
    <h1>Contact Us</h1>
    <p>We're here to help with your UGC API queries.</p>
</section>
...
<section class="contact-container">
    ...
    <div class="input-group">
        ...
        <div class="error-text" id="subjectError">Subject is required</div>
    </div>

    <div class="input-group">
        <textarea name="message" id="message" placeholder="Your Message"></textarea>
        <div class="error-text" id="messageError">Message cannot be empty</div>
    </div>
    ...
    <div class="contact-info">
        ...
        <div class="info-card">
            ...
            <div class="map-container">
                <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d41235.78939011105!2d77.64492494379044!3d27.443747165543446!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3973716a8f335ddf%3A0xe21b9d0d7c38c65b!2sGenome%20Biotech%20Publication%20Services!5e1!3m2!1sen!2sin!4v1770403927085!5m2!1sen!2sin" 
                    allowfullscreen="" 
                    loading="lazy" 
...
<script>
    ...
    // 4. Unified Form Validation and Submission
