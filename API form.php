...
<head>
    ...
    <style>
        ...
        /* FIX 1: Removed negative-margin logo styles; header now uses flexbox */
        .logo img{
            width: 90px;
            height: 95px;
            border-radius: 20%;
        ...
        * {
        ...
        /* FIX 1: Header now uses flexbox — logo left, h1 center, subtitle right */
        header {
        ...
        /* FIX 2: Wrap the form-grid in a scrollable container for mobile */
        .form-grid-wrapper {
            overflow-x: auto;
        ...
        .form-grid {
            ...
            margin-bottom: 25px;
            align-items: center ;
            min-width: 600px; /* ensures table doesn't collapse to unusable widths */
        }
...
<body>
    <div class="container">
        <!-- FIX 1: Three-section flex header -->
        <header>
            ...
            <div class="header-subtitle subtitle">
                Based on UGC Regulation - 2018 (Table 3A) for Shortlisting of candidates for Interview for the Post of
                Assistant Professor in Universities
            </div>
        </header>

        <div class="calculator-form">
            <!-- FIX 2: Scrollable wrapper around form-grid -->
...
<span class="hint">Graduation 
    <span class="tooltiptext">80% & Above = 21, 60-80% = 19, 55-60% = 16, 45-55% = 10</span>
                ...
                <div class="form-row">
                    <div class="criteria">
                       <!-- Post Graduation -->
<span class="hint">Post Graduation 
